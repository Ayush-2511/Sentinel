...
export default function SurvivalTracker({ civilians }) {
  ...
  const total = civilians?.length ?? 0;
      ...
      <div className="shrink-0 p-3 border-b border-navyBorder">
        ...
        <div className="grid grid-cols-3 gap-1 mt-2">
          <div className="text-center py-1 bg-navyMid border border-navyBorder rounded-sm group">
            <div className="font-data text-[18px] font-bold text-success">{alive}</div>
            <div className="font-mono-custom text-[9px] text-muted tracking-[1px]">ALIVE</div>
          </div>
          <div className="text-center py-1 bg-navyMid border border-navyBorder rounded-sm group">
            <div className="font-data text-[18px] font-bold text-warning">{critical}</div>
            <div className="font-mono-custom text-[9px] text-muted tracking-[1px]">CRIT</div>
          </div>
          <div className="text-center py-1 bg-navyMid border border-navyBorder rounded-sm group">
            <div className="font-data text-[18px] font-bold text-danger">{dead}</div>
            <div className="font-mono-custom text-[9px] text-muted tracking-[1px]">DEAD</div>
          </div>
        </div>
      </div>
    </>
